	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="container">
				...
				<section id="featured">
			<!-- start slider -->
					<div class="col-lg-12" style="margin-top: -50px;"> <!-- style="background-color: #f7f7f7; --> 
						<!-- Slider -->
						<div id="main-slider" class="flexslider">
							<ul class="slides">
								<li>
									<img src="/webM2/img/slides/1.jpg" alt="" />
								</li>
								<li>
									<img src="/webM2/img/slides/2.jpg" alt="" />
								</li>
								<li>
									<img src="/webM2/img/slides/3.jpg" alt="" />
								</li>
							</ul>
						</div>
						<!-- end slider -->
